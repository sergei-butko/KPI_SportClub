...
function Signup() {
    ...
    const signUp = async (e: FormEvent) => {
        ...
        await postSignUp(signUpData)
            .then(()=>{
                alert('Account successfully created. LogIn using provided credentials');
    ...
    return (
        <div className='flex flex-col items-center'>
            <div
                className={`p-12 h-max rounded-xl py-24 mt-12 bg-no-repeat ${styles.formContainer} border-violet-300 bg-white/50 w-[580px] flex flex-col items-center`}>
                <h2 className="text-center text-3xl mb-16">Sing Up</h2>
